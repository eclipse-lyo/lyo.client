 ...
 *
 */
public class TestRMSampleForJAXRS2 {

	private static final Logger logger = Logger.getLogger(TestRMSampleForJAXRS2.class.getName());
...
//			}
	...
	private static void printChangeRequestInfo(Requirement cr) {
