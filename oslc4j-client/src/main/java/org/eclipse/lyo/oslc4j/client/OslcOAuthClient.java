...
import org.eclipse.lyo.oslc4j.client.exception.OAuthRedirectException;
...
public class OslcOAuthClient extends OslcClient {
    ...
    private Map<String, String> appendAuthorizationRequestHeader(String url, Map<String, String> requestHeaders) throws IOException, OAuthException, URISyntaxException {
    ...
    public Response getResource(String url) throws IOException, OAuthException, URISyntaxException {
        Map<String, String> requestHeaders = appendAuthorizationRequestHeader(url, null);
        return super.getResource(url, requestHeaders, OSLCConstants.CT_RDF, null, true);
    }

    @Override
    public Response getResource(String url, String defaultMediaType) throws IOException, OAuthException, URISyntaxException {
        Map<String, String> requestHeaders = appendAuthorizationRequestHeader(url, null);
        return super.getResource(url, requestHeaders, defaultMediaType, null, true);
    }

    @Override
	public Response getResource(String url, Map<String, String> requestHeaders, String defaultMediaType, String configurationContext, boolean handleRedirects) throws IOException, OAuthException, URISyntaxException {
        requestHeaders = appendAuthorizationRequestHeader(url, requestHeaders);
		return super.getResource(url, requestHeaders, defaultMediaType,configurationContext, handleRedirects);
	}
	...
	protected OAuthMessage getResourceInternal(String url, String httpMethod, boolean restart) throws IOException, OAuthException, URISyntaxException {
		...
		if (!isTwoLegged()) {
			...
			if (accessor.requestToken == null) {
                ...
                OAuthRedirectException oAuthRedirectException = new OAuthRedirectException(accessor.consumer.serviceProvider.userAuthorizationURL, accessor);
				log.debug("Consumer should redirect user to this authorization URL, and re-run the http request: " + 
				        oAuthRedirectException.getRedirectQuery("currentRequestUrl"));
